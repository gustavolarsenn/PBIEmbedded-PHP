...
require_once __DIR__ .'\\..\\PBI\\PowerBISession.php';    
require_once __DIR__ .'\\..\\PBI\\AzureAPI.php';
...
class Capacidade {
    ...
    private const TEMPO_ESPERA = 2.5;
    ...
    function criarArquivoBat($nomeArquivo){
        ...
        try {        
            if (!file_exists($nomeArquivo)) {
                ...
                $conteudo .= 'start /min php ' . __DIR__ . '\\..\\config\\capacidade\\AgendadorCapacidade.php' . PHP_EOL;
                $conteudo .= 'exit'; 
    
                file_put_contents(__DIR__ . '\\..\\config\\capacidade\\' . $nomeArquivo, $conteudo);
    ...
    function criarTarefaChecarCapacidade(){
        ...
        */
        try {
            ...
            $caminhoScript = __DIR__ . '\\..\\config\\capacidade\\' . $nomeArquivoBat;
        ...
        */
        try {
            ...
            if ($returnVar === 0) {
                ...
                $log->error("Erro ao disparar tarefa '$nomeTarefa'. Output: " . implode("\n", $output));
            }
        } catch (Exception $e) {
