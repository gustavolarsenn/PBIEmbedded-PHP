        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="icon icon-single-04"></i><span class="nav-text">Cadastro</span></a>
                <ul aria-expanded="false">
                    ...
                    <li><a href="/views/cadastro/usuario.php">Usuário</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                ...
                <li><a href="/views/relatorio/relatorio_balanca.php">Relatório Balança</a></li>
                <li><a href="/views/relatorio/relatorio_controle_prancha.php">Controle de Prancha</a></li>
                </ul>
            </li>
